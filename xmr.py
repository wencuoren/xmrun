...
def getBeijinTime():
    ...
    if min_1 != 0 and max_1 != 0:
        # 登录账户 多账号用#分开 例如:user_mi = '1323213@qq.com'
        user_mi = ''
        # 登录密码 多账号用#分开 例如:passwd_mi = '12321321312'
        passwd_mi = ''
...
def main(_user, _passwd, min_1, max_1):
    ...
    data = f'userid={userid}&last_sync_data_time={t}&device_type=0&last_deviceid=DA932FFFFE8816E7&data_json={data_json}'
